...
//! Docker source: the running containers degc may route.
...
/// A running container relevant to degc.
#[derive(Debug, Clone)]
pub struct Target {
    pub name: String,
    pub labels: BTreeMap<String, String>,
    /// Docker network attachments: network name → the container's addresses.
